...
public class HelperFunctions {
	...
	// Code from: https://github.com/abramhindle/BogoPicGen/blob/master/src/es/softwareprocess/bogopicgen/BogoPicGen.java
	// Used to generate a random bitmap picture in order to test the model
